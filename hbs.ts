import { AST } from "https://esm.sh/@handlebars/parser@2.1.0";

export type { AST } from "https://esm.sh/@handlebars/parser@2.1.0";
export { parse as parseTemplate } from "https://esm.sh/@handlebars/parser@2.1.0";
